<template>
  <div>
    <footer class="footer flex flex-col bg-grey-800 pt-14 pb-24">
      ...
      >
        <section
          class="w-full md:w-1/3 flex justify-center flex-col px-8 mb-12"
        >
          <h3
            class="font-bold uppercase mb-2 underline underline-offset-4 inline-block"
          >
            Company
          </h3>
          <ul>
        ...
        <section class="flex flex-col justify-center items-center px-4">
          <h1
            class="text-xl text-gray-100 uppercase font-bold mb-4 text-center"
          >
